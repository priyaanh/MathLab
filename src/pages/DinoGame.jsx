...
// T-Rex: shared head/body/tail, only the legs swap between frames. Head has a
// hollow eye and an open-mouth notch, matching Chrome's sprite.
const REX_BODY = [
    '                      ###########  ',
    '                     ############# ',
    '                     ############# ',
...
// ducking T-Rex: long and low, same head
const DUCK = [
    '                          ##########   ',
    '                         ############# ',
    '                         ############# ',
